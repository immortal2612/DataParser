...
public class DataManager {
    ...
    public DataManager(ArrayList<ElectionResult> a, ArrayList<Education2016> b){
        createStates(a, b);
    }

    private void createStates(ArrayList<ElectionResult> a, ArrayList<Education2016> b) {
        for(int i = 0; i < StateFips.length - 1; i++){
            ...
            State x = new State(stateEdu.getState(), countyVotes, stateEdu);
